...
A wide variety of geoms are available. Here we show violin plots. Note again the use of the "group" aesthetic, without this ggplot will just show one big box-plot. `geom_jitter`, `geom_boxplot`, and the [ggbeeswarm](https://cran.r-project.org/web/packages/ggbeeswarm/index.html) package are some further ways to show distributions.
